...
/**
 * @brief Iterate over all the threads in running on current cpu.
 *
 * This function is does otherwise the same thing as k_thread_foreach(),
 * but it only loops through the threads running on current core. If
 * CONFIG_SMP is not defined the implementation this is the same as
 * k_thread_foreach().
 *
 * @param user_cb Pointer to the user callback function.
 * @param user_data Pointer to user data.
 ...
 * running on current core. If CONFIG_SMP is not defined the
 * implementation this is the same as k_thread_foreach_unlocked().
 *
 * @param user_cb Pointer to the user callback function.
 * @param user_data Pointer to user data.
 *
 ...
 */
#ifdef CONFIG_SMP
void k_thread_foreach_unlocked_my_core(k_thread_user_cb_t user_cb, void *user_data);
#else
static inline
void k_thread_foreach_unlocked_my_core(k_thread_user_cb_t user_cb, void *user_data)
{
