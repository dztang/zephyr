...
#define BT_HCI_PKT_CMD                  0x01    /* HCI Command packet */
#define BT_HCI_PKT_ACL                  0x02    /* HCI ACL Data packet */
#define BT_HCI_PKT_SCO                  0x03    /* HCI Synchronous Data packet */
#define BT_HCI_PKT_EVT                  0x04    /* HCI Event packet */
#define BT_HCI_PKT_ISO                  0x05    /* HCI ISO Data packet */
