...
/**
 * Verify that arch_sched_ipi() directs/broadcasts IPIs as expected.
 */
ZTEST(ipi, test_arch_sched_ipi)
{
...
#if CONFIG_ARCH_HAS_DIRECTED_IPIS
	/*
...
#if defined(CONFIG_ARCH_HAS_DIRECTED_IPIS)
		unsigned int j;
