...
static struct emul_mspi_device_stub_dev_data stub_device_data;
static struct emul_mspi_device_stub_dev_config stub_device_config;
static struct emul_mspi_device_stub_dev_api stub_device_api;
