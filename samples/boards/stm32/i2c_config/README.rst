...
the i2c_ll_stm32_v2.c driver should not embed it.
That piece of code is activated by the CONFIG_I2C_STM32_V2_TIMING flag
which must **not be set** except by this sample.
